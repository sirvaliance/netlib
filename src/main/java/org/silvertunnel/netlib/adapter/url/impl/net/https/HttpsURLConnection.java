...
import org.silvertunnel.netlib.adapter.url.impl.net.http.Handler;
import org.silvertunnel.netlib.adapter.url.impl.net.http.HttpClient;
import org.silvertunnel.netlib.adapter.url.impl.net.http.HttpURLConnection;
...
public class HttpsURLConnection extends HttpURLConnection {
    ...
    public void setNewClient (URL url, boolean useCache)
        throws IOException {
        http = HttpsClient.New (lowerNetLayer,
                                url,
                                /*getHostnameVerifier()*/ null,
                                useCache);
