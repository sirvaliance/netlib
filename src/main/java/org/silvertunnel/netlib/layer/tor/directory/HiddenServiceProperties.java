...
public class HiddenServiceProperties {
    private static final Logger log = Logger.getLogger(HiddenServiceProperties.class.getName());
    ...
    private void init(int port, HiddenServiceRequestHandler handler,
            Set<SDIntroductionPoint> introPoints) throws TorException {
        this.port = port;
        ...
        try {
            ...
            log.severe("HiddenServiceProperties: Caught exception: " + e.getMessage());
    ...
    */
    ...
    private void init(int port,
            Set<SDIntroductionPoint> introPoints, RSAKeyPair keyPair) throws TorException {
        this.port = port;
        this.introPoints = introPoints;
        minimumNumberOfIntroPoints = 3;
