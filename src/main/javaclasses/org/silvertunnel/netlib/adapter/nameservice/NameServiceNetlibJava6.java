...
/**
 * Implementation of sun.net.spi.nameservice.NameService - for Java 1.6 or higher only!
 * 
 * This method can only be compiled with Java 1.6 (not with Java 1.5).
 * Therefore it is pre-compiled in the src/main/resources/ tree.
 * 
 * @author hapke
 */
public class NameServiceNetlibJava6 implements NameService {
    /** all method calls will be forwarded to this nameServiceNetlibGenericAdapter */
    private NameServiceNetlibGenericAdapter nameServiceNetlibGenericAdapter;
    
    /**
     * 
     * @param nameServiceNetlibGenericAdapter    all method calls will be forwarded to this nameServiceNetlibGenericAdapter
     */
