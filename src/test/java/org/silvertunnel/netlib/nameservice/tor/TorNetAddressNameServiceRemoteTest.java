...
import org.silvertunnel.netlib.layer.tor.TorRemoteAbstractTest;

/**
 * Test TorNetAddressNameService's basic features.
 * 
 * Similar test cases:
 * @see org.silvertunnel.netlib.nameservice.inetaddressimpl.DefaultIpNetAddressNameServiceRemoteTest
 * 
 * @author hapke
 */
public class TorNetAddressNameServiceRemoteTest extends TorRemoteAbstractTest {
    private static final Logger log = Logger.getLogger(TorNetAddressNameServiceRemoteTest.class.getName());
     ...
     * 
     * Some ISPs resolve every name to an IP address (to redirect web traffic to their servers) -
     * when the exit node is connected to such a ISP then this test will fail.
     * 
     * @throws Exception
     */
    @Test(timeout=90000)
