...
/**
 * JUnit test to test the JUnit execution environment test isolation:
 * Each test case class should be executed in a separate JVM.
 * This will be enforced by ant task junit/batchtest
...
public class JUnitForkMode2LocalTest {
    private static final Logger log = Logger.getLogger(JUnitForkMode2LocalTest.class.getName());
