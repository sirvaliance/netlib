...
public class HttpUtilRemoteTest {
    private static final Logger log = Logger.getLogger(HttpUtilRemoteTest.class.getName());
    ...
    public void testGetRequest() throws Exception {
        ...
        NetSocket netSocket = netLayer.createNetSocket(null, null, HttpUtil.HTTPTEST_SERVER_NETADDRESS);
        ...
        assertEquals("wrong response", expectedResponse, new String(httpResponse, UTF8));
