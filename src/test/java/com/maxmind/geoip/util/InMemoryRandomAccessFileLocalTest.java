...
public class InMemoryRandomAccessFileLocalTest {
    ...
    public void testRead() throws Exception {
        ...
        byte[] dataSource = {2, 4, 6, 8, 10};
        int maxSize = 10;
        InMemoryRandomAccessFile f = new InMemoryRandomAccessFile(new ByteArrayInputStream(dataSource), maxSize);
        ...
        byte[] expectedBuffer = {6, 8};
        f.read(buffer);
        assertEquals("wrong 2nd+3rd bytes", Arrays.toString(expectedBuffer), Arrays.toString(buffer));
